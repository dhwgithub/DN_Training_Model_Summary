...
def train_footer_model():
    ...
    print('===============================================  数据集准备  ===============================================')
    TRAIN_FOOTER_DATA_PATH = r'.\datasets\footer\rvl_cdip_train_footer.tfrecords'
    TEST_FOOTER_DATA_PATH = r'.\datasets\footer\rvl_cdip_test_footer.tfrecords'
    VAL_FOOTER_DATA_PATH = r'.\datasets\footer\rvl_cdip_val_footer.tfrecords'

    train_data = get_datasets.get_dataset_by_tfrecords(TRAIN_FOOTER_DATA_PATH)
    val_data = get_datasets.get_dataset_by_tfrecords(VAL_FOOTER_DATA_PATH)
    test_data = get_datasets.get_dataset_by_tfrecords(TEST_FOOTER_DATA_PATH)
    ...
    model = footer(holistic)
    checkpoint_save_path = r"./model/Footer-model/Footer.ckpt"
    my_tools.save_and_load_models(checkpoint_save_path, log_file, model, 'footer')
    ...
    print('===============================================  可视化模型  ===============================================')
    loss__and_acc_img_path = r'./footer_loss_and_acc_model.jpg'
    # 可视化并保存图片
