...
class rightbody(Model):
    def __init__(self, holistic):
        super(rightbody, self).__init__()
...
def train_rightbody_model():
    ...
    print('===============================================  数据集准备  ===============================================')
    TRAIN_RIGHTBODY_DATA_PATH = r'.\datasets\rightbody\rvl_cdip_train_rightbody.tfrecords'
    TEST_RIGHTBODY_DATA_PATH = r'.\datasets\rightbody\rvl_cdip_test_rightbody.tfrecords'
    VAL_RIGHTBODY_DATA_PATH = r'.\datasets\rightbody\rvl_cdip_val_rightbody.tfrecords'

    train_data = get_datasets.get_dataset_by_tfrecords(TRAIN_RIGHTBODY_DATA_PATH)
    val_data = get_datasets.get_dataset_by_tfrecords(VAL_RIGHTBODY_DATA_PATH)
    test_data = get_datasets.get_dataset_by_tfrecords(TEST_RIGHTBODY_DATA_PATH)
    ...
    model = rightbody(holistic)
    checkpoint_save_path = r"./model/RightBody-model/RightBody.ckpt"
    my_tools.save_and_load_models(checkpoint_save_path, log_file, model, 'rightbody')
    ...
    print('===============================================  可视化模型  ===============================================')
    loss__and_acc_img_path = r'./rightbody_loss_and_acc_model.jpg'
    # 可视化并保存图片
