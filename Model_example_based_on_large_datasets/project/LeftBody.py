...
class leftbody(Model):
    def __init__(self, holistic):
        super(leftbody, self).__init__()
...
def train_leftbody_model():
    ...
    print('===============================================  数据集准备  ===============================================')
    TRAIN_LEFTBODY_DATA_PATH = r'.\datasets\leftbody\rvl_cdip_train_leftbody.tfrecords'
    TEST_LEFTBODY_DATA_PATH = r'.\datasets\leftbody\rvl_cdip_test_leftbody.tfrecords'
    VAL_LEFTBODY_DATA_PATH = r'.\datasets\leftbody\rvl_cdip_val_leftbody.tfrecords'

    train_data = get_datasets.get_dataset_by_tfrecords(TRAIN_LEFTBODY_DATA_PATH)
    val_data = get_datasets.get_dataset_by_tfrecords(VAL_LEFTBODY_DATA_PATH)
    test_data = get_datasets.get_dataset_by_tfrecords(TEST_LEFTBODY_DATA_PATH)
    ...
    model = leftbody(holistic)
    checkpoint_save_path = r"./model/LeftBody-model/LeftBody.ckpt"
    my_tools.save_and_load_models(checkpoint_save_path, log_file, model, 'leftbody')
    ...
    print('===============================================  可视化模型  ===============================================')
    loss__and_acc_img_path = r'./leftbody_loss_and_acc_model.jpg'
    # 可视化并保存图片
