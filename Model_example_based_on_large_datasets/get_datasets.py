...
# 生成tfrecords格式数据集
def make_tfrecords_datasets(save_datasets_path, datasets_path):
...
if __name__ == '__main__':
    pass
    # # 生成tfrecords格式数据集
    # save_datasets_path = r'./datasets/rvl_cdip_mini_tr.tfrecords'
    # datasets_path = r'E:\pycharm\tensorflow-learn\paper\datasets\RVL-CDIP\labels\tr.txt'
    # make_tfrecords_datasets(save_datasets_path, datasets_path)
